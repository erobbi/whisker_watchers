...
max = Cat.create(name: "Max", age: 8, cat_url: "https://i.ibb.co/j4N7G6h/IMG-2841.jpg", caloriesPerDay: 2, bcs: 7, isNeutered: true, user_id: eli.id)
luna = Cat.create(name: "Luna", age: 6, cat_url: "https://i.ibb.co/rpDBM7Q/Cat1.jpg", caloriesPerDay: 2, bcs: 9, isNeutered: true, user_id: eli.id)
oliver = Cat.create(name: "Oliver", age: 6, cat_url: "https://i.ibb.co/2FShhW6/Cat2.jpg", caloriesPerDay: 2, bcs: 5, isNeutered: true, user_id: eli.id)
