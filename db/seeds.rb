...
max = Cat.create(name: "Max", age: 8, cat_url: "https://i.ibb.co/j4N7G6h/IMG-2841.jpg", food_per_day: 2, user_id: eli.id)
luna = Cat.create(name: "Luna", age: 6, cat_url: "https://i.ibb.co/rpDBM7Q/Cat1.jpg", food_per_day: 2, user_id: eli.id)
oliver = Cat.create(name: "Oliver", age: 6, cat_url: "https://i.ibb.co/2FShhW6/Cat2.jpg", food_per_day: 2, user_id: eli.id)
